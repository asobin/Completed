 ...
 * @author maman,sobin
 */
public class ComparableOG<String extends Comparable<String>,
Integer extends Comparable<Integer>>
implements Comparator<SimpleHashMap.Entry<String, Integer, String>> 
{
    /**
     ...
     */
    @Override
    public int compare(SimpleHashMap.Entry<String, Integer, String> a, 
            SimpleHashMap.Entry<String, Integer, String> b) 
    {
        //save int value of compareTo method to determine ordering in list 
        int cmp1 = b.getSpecies().compareTo(a.getSpecies());
